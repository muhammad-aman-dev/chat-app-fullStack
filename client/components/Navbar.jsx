  ...
  return (
    <header>
        <nav className='flex justify-between items-center sm:pt-6 sm:px-6'>
           ...
           {authUser && (
           <button onClick={logOut} className="px-5 py-2 rounded-xl font-semibold text-white bg-gradient-to-r from-yellow-400 via-amber-400 to-orange-400 shadow-lg hover:shadow-amber-400/50 transition-all cursor-pointer hover:scale-105 duration-300">Logout</button>
           )}
        </nav>
    </header>
  )
